...
bear = Sound(ipa_symbol="b")
beaver = Sound(ipa_symbol="v")
blue = Sound(ipa_symbol="u")
brown = Sound(ipa_symbol="aʊ")
cat = Sound(ipa_symbol="k")
chicken = Sound(ipa_symbol="ʧ")
coffee = Sound(ipa_symbol="ɑ")
dinosaur = Sound(ipa_symbol="n")
dog = Sound(ipa_symbol="d")
dust = Sound(ipa_symbol="ə")
feather = Sound(ipa_symbol="ð")
frog = Sound(ipa_symbol="f")
giraffe = Sound(ipa_symbol="ʤ")
goat = Sound(ipa_symbol="g")
gold = Sound(ipa_symbol="oʊ")
green = Sound(ipa_symbol="i")
horse = Sound(ipa_symbol="h")
jade = Sound(ipa_symbol="eɪ")
lime = Sound(ipa_symbol="aɪ")
lion = Sound(ipa_symbol="l")
mauve = Sound(ipa_symbol="ɔ")
mouse = Sound(ipa_symbol="m")
panther = Sound(ipa_symbol="θ")
penguin = Sound(ipa_symbol="ŋ")
pig = Sound(ipa_symbol="p")
pink = Sound(ipa_symbol="ɪ")
purple = Sound(ipa_symbol="ɜ")
rabbit = Sound(ipa_symbol="ɹ")
red = Sound(ipa_symbol="ɛ")
sand = Sound(ipa_symbol="æ")
sheep = Sound(ipa_symbol="ʃ")
snake = Sound(ipa_symbol="s")
television = Sound(ipa_symbol="ʒ")
turquoise = Sound(ipa_symbol="ɔɪ")
turtle = Sound(ipa_symbol="t")
wolf = Sound(ipa_symbol="w")
wood = Sound(ipa_symbol="ʊ")
yak = Sound(ipa_symbol="j")
zebra = Sound(ipa_symbol="z")
extra = Sound(ipa_symbol="ɨ") # same as i
extra2 = Sound(ipa_symbol="ʌ") # same as ə
extra3 = Sound(ipa_symbol="o") # same as oʊ
extra4 = Sound(ipa_symbol="ɾ") # same as d
extra5 = Sound(ipa_symbol="ɯ") # same as ʊ
